...
## App Pages
- **Homepage**: Welcoming page with bakery branding and featured products.
- **Product Catalog**: Grid layout displaying all products with filtering options.
- **Product Detail**: Detailed view of a single product with nutritional information.
- **Shopping Cart**: Displays selected items with options to adjust quantities and special instructions.
